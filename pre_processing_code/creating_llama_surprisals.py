...
INPUT_DATA_PATH = "data\\preview_inside_critical_span_words.csv"
# INPUT_DATA_PATH = "data\\preview.csv"
# MODEL_NAME = "EleutherAI/pythia-70m"
MODEL_NAME = "meta-llama/Llama-2-7b-hf"
MODEL_UNOFFICIAL_NAME = "Llama"
OUTPUT_SURPRISALS_PATH = "pre_processing_open_data\\only_paragraph_as_context\\inside_span\\llama7B_surprisals.csv"
...
def create_surprisals_file_using_network_model(input_data_path, model_surprisals_path, model_name, is_question_in_prompt, model_unofficial_name):
...
if __name__ == "__main__":
    create_surprisals_file_using_network_model(INPUT_DATA_PATH, OUTPUT_SURPRISALS_PATH, MODEL_NAME, is_question_in_prompt=False, model_unofficial_name=MODEL_UNOFFICIAL_NAME)